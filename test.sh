...
FILES=( "Spacearr.Api.Test.dll" "Spacearr.Automation.Test.dll" "Spacearr.Common.Test.dll" "Spacearr.Core.Test.dll" "Spacearr.Host.Test.dll" "Spacearr.Integration.Test.dll" "Spacearr.Libraries.Test.dll" "Spacearr.Mono.Test.dll" "Spacearr.Update.Test.dll" "Spacearr.Windows.Test.dll" )
ASSMEBLIES=""
...
export SPACEARR_TESTS_LOG_OUTPUT="File"
...
if [ "$PLATFORM" = "Windows" ]; then
  mkdir -p "$ProgramData/Spacearr"
  WHERE="$WHERE&Category!=LINUX"
elif [ "$PLATFORM" = "Linux" ]; then
  mkdir -p ~/.config/Spacearr
  WHERE="$WHERE&Category!=WINDOWS"
elif  [ "$PLATFORM" = "Mac" ]; then
  mkdir -p ~/Library/Application\ Support/Spacearr
  WHERE="$WHERE&Category!=WINDOWS"
else
