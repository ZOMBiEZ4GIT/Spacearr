...
- Logs are a fraction of the size. EF Core SQL and per-request ASP.NET Core pipeline messages now log at Warning; the one-line request summary is unchanged.
