...
namespace NzbDrone.Core.Datastore.Migration
{
    ...
    public class fix_trakt_list_config : NzbDroneMigrationBase
    {
        ...
        protected override void MainDbUpgrade()
        {
            ...
            Execute.WithConnection(RenameSpacearrListType);
        ...
        private void RenameSpacearrListType(IDbConnection conn, IDbTransaction tran)
        {
            var rows = conn.Query<ProviderDefinition169>($"SELECT \"Id\", \"Implementation\", \"ConfigContract\", \"Settings\" FROM \"NetImport\" WHERE \"Implementation\" = 'SpacearrLists'");
            ...
            foreach (var row in rows)
            {
                ...
                {
                    Id = row.Id,
                    Implementation = "SpacearrListImport",
                    ConfigContract = "SpacearrListSettings"
                });
            }
