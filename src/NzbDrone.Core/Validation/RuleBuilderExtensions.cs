...
namespace NzbDrone.Core.Validation
{
    public static class RuleBuilderExtensions
    {
        ...
        public static IRuleBuilderOptions<T, string> ValidUrlBase<T>(this IRuleBuilder<T, string> ruleBuilder, string example = "/spacearr")
        {
        ...
        public static IRuleBuilderOptions<T, string> ContainsSpacearr<T>(this IRuleBuilder<T, string> ruleBuilder)
        {
            ruleBuilder.SetValidator(new NotEmptyValidator(null));
            return ruleBuilder.SetValidator(new RegularExpressionValidator("spacearr", RegexOptions.IgnoreCase)).WithMessage("Must contain Spacearr");
        }
