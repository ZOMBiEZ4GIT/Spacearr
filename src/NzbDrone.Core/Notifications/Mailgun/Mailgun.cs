...
namespace NzbDrone.Core.Notifications.Mailgun
{
    public class MailGun : NotificationBase<MailgunSettings>
    {
        ...
        public override string Link => "https://mailgun.com";        public override void OnHealthIssue(HealthCheck.HealthCheck healthCheckMessage)
        {
        ...
        public override ValidationResult Test()
        {
            ...
            try
            {
                ...
                const string body = "This is a test message from Spacearr, though Mailgun.";
